...
public class ViewDragHelper {
    ...
    private int getEdgeTouched(int x, int y) {
        int result = 0;
//        Log.d("getEdgeTouched", "left=="+mParentView.getLeft());
//        Log.d("getEdgeTouched", "top=="+mParentView.getTop());
//        Log.d("getEdgeTouched", "right=="+mParentView.getRight());
//        Log.d("getEdgeTouched", "bottom=="+mParentView.getBottom());
//        
//        Log.d("getEdgeTouched", "mEdgeSize=="+mEdgeSize);
//        Log.d("getEdgeTouched", "x=="+x);
//        Log.d("getEdgeTouched", "y=="+y);
