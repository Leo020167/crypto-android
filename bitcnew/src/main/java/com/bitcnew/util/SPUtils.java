...
//    String memberId = (String) SPUtils.get(getActivity(), "memberId", "");
//    SPUtils.put(getActivity(), "tel", "");
    /**
     ...
     */
    public static Map<String, ?> getAll(Context context, String memberId, String s) {
        SharedPreferences sp = context.getSharedPreferences(FILLNAME, Context.MODE_PRIVATE);
        return sp.getAll();
    }
