...
public class SpUtils2{
    private static Map<String, SpUtils2> map = new HashMap<>();
         ...
         */
        public static SpUtils2 getInstance(Context context) {
         ...
         * @return {@link SpUtils2}
         */
        public static SpUtils2 getInstance(Context context, String spName) {
            if (isSpace(spName))
                spName = "config";
            SpUtils2 instance = map.get(spName);
            if (instance == null) {
