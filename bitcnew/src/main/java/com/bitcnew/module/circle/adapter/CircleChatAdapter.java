...
import com.bitcnew.module.circle.CircleChatRoomActivity;
import com.bitcnew.module.circle.CircleChatViewPagerPhotoViewActivity;
...
import com.bitcnew.util.TextViewFixTouchConsume;
import com.bitcnew.util.VeDate;
import com.bitcnew.MainApplication;
import com.bitcnew.util.MyClickableSpanUtil;
import com.bitcnew.R;
import com.bitcnew.common.base.BasePlayVoiceAdapter;
...
import com.bitcnew.module.circle.entity.VoiceEntity;
import com.bitcnew.module.circle.entity.parser.CircleKlineBoxParser;
...
public class CircleChatAdapter extends BasePlayVoiceAdapter<CircleChatEntity> implements PlayVoiceUtilView.VoiceLoadAndPlay {
    private CircleChatRoomActivity context;
    private User user;
...
//    private BoxBeanCheckTask boxBeanCheckTask;
    ...
    public CircleChatAdapter(CircleChatRoomActivity context, User user, int role) {
...
//            Log.d("154","showTime == "+item.showTime +" createTime == "+item.createTime);
            ...
            if (item.showTime || showTime(pos)) {
                ...
                tvTime.setText(DateUtils.getChatTimeFormat3(VeDate.strLongToDate(String.valueOf(item.createTime))));
            } else {
            ...
            if (ivHead != null) {//因为tip类型没有头像所以要判断空
                ...
                ivHead.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        context.addAt2EditText(item.userId, item.name);
                        return true;
                    }
                });
            }
...
//            tvRoleName = (TextView) convertView.findViewById(R.id.tvRoleName);
        ...
        public void setData(int pos) {
            CircleChatEntity entity = getItem(pos);
            tvName.setText(entity.name);
            setImgaeWidthHeight(bubbleImage, entity.say, pos);
...
//            }
    ...
    private void setImgaeWidthHeight(ImageView bubbleImage, String say, final int pos) {
...
//            bubbleImage.setImageResource(R.drawable.xml_bubbleview_default_src);//先设置默认值
            Log.d("bubbleImage", "imgUrl==" + imgUrl + "  pos==" + pos );
...
//        lp.height=(imageViewWidth+(int) bubbleImage.getmArrowWidth())*imageViewHeight/imageViewWidth;
    ...
    class ViewHolderImgRight extends ViewHolderBase {
        ...
        public void setData(int pos) {
            final CircleChatEntity entity = getItem(pos);
//            bubbleImage.setImageResource(R.drawable.app_logo);
            setImgaeWidthHeight(bubbleImage, entity.say, pos);
            if (entity.state == 1) {
                pb.setVisibility(View.VISIBLE);
                ivReSend.setVisibility(View.GONE);
    ...
    public void play(File file, int pos, int followPos) {
        ...
        if (CircleChatTypeEnum.isVoice(entity.say)) {
            if (entity.voiceIsRed == 1) {
                entity.voiceIsRed = 0;
                notifyDataSetChanged();
                db.clearCircleChatVoiceRed(user.getUserId(), entity.chatTopic, entity.chatMark);
            }
        }
...
//            }
            ...
            if (!TextUtils.isEmpty(entity.say)) {
                ...
                rlVoice.setVoiceEntityAndCallBack(new VoiceEntity(voiceUrl, length), CircleChatAdapter.this, pos, 0, playingPos, 0);
//                if(tryPlayPos==pos){
    ...
    private class MyOnLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            ...
            if (entity.type == 0) {//文字,除了文字有复制其他全部删除
                items = new String[]{context.getResources().getString(R.string.fuzhi), context.getResources().getString(R.string.shanchu)};
            } else {
                items = new String[]{context.getResources().getString(R.string.shanchu)};
            }
...
//                dilog.dismiss();
    ...
    private class MyImgOnClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            bundle.putString(CommonConst.CIRCLEID, entity.chatTopic);
            bundle.putInt(CommonConst.CIRCLECHATMARK, entity.chatMark);
            bundle.putBoolean(CommonConst.ISPRIVATECHAT, false);
...
//    }
            ...
            switch (which) {
                case 0:
                    if (entity.type == 0) {
                        ...
                        int result = db.delCircleChat(user.getUserId(), entity.chatTopic, entity.chatMark);
    ...
    protected void showReSendMsgDialog(CircleChatEntity entity) {
        ...
        if (reSendMsgDialog == null) {
            ...
            reSendMsgDialog.setTvTitle(context.getResources().getString(R.string.tishi));
            reSendMsgDialog.setMessage(context.getResources().getString(R.string.quedingchongfugaixiaoxi));
            reSendMsgDialog.setBtnColseText(context.getResources().getString(R.string.bule));
            reSendMsgDialog.setBtnOkText(context.getResources().getString(R.string.chongfa));
        }
