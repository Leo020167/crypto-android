...
public class PlayCoinPlanAdapter extends BaseImageLoaderRecycleAdapter<SubUser> {
    ...
    public PlayCoinPlanAdapter(Context context, String myUserId) {
//        super(context, R.drawable.ic_common_mic2);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.play_rank_item, parent, false));
    }
...
//        TextView tvFollow;
        ...
        public void setData(final SubUser data, final int pos) {
            ...
            tvFollowCount.setText(data.fanNum + context.getResources().getString(R.string.geguanzhu));
