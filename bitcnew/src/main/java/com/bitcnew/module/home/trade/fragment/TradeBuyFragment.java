...
//            ((TradeActivity) getActivity()).hideCopy();
    ...
    private void setData() {
        if (checkOut != null) {
            ...
            etEnableAmount.setText("可用 " + checkOut.myCoin + com.bitcnew.util.CommonUtil.getUnitSymbol(symbol));
        ...
        switch (v.getId()) {
            case R.id.tvBuy:
                ...
                if (TextUtils.isEmpty(price)) {
                    com.bitcnew.util.CommonUtil.showmessage(getActivity().getResources().getString(R.string.qingshurumairujiage), getActivity());
                    return;
                }
                if (TextUtils.isEmpty(amount)) {
                    com.bitcnew.util.CommonUtil.showmessage(getActivity().getResources().getString(R.string.qingshurumairushuliang), getActivity());
                    return;
                }
...
//                        return;
//                    }
//                String tips = "您将以" + price + com.bitcnew.util.CommonUtil.getUnitSymbol(symbol)+"价格委托买入" + amount + com.bitcnew.util.CommonUtil.getOriginSymbol(symbol);
    ...
    private void showSubmitTipsDialog(String tips, final String moneyOrAmount, final String price, final String balance) {
        ...
        submitTipsDialog.setTvTitle(getActivity().getResources().getString(R.string.mairugaiyao));
