...
public class KeyTypeAdapter extends RecyclerView.Adapter {
    ...
    public void setOnItemclickListen(KeyTypeAdapter.onItemclickListen onItemclickListen) {
    ...
    public KeyTypeAdapter(Context context) {
