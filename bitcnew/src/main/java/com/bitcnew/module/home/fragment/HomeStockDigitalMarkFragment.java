...
//    LinearLayout llSearch;
    ...
    private String accountType="stock";//stock全球指数，digital合约，spot币币
...
//        mImmersionBar.statusBarDarkFont(false, CommonConst.STATUSBAR_ALPHA).init();
    ...
    private void startGetMarket() {
        ...
        getHomeMarketCall = VHttpServiceManager.getInstance().getMarketService().marketData2(sortField, sortType, String.valueOf(accountType));
