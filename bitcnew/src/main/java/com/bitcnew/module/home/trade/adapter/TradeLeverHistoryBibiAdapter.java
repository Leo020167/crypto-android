    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(final Position data, final int pos) {
            if (!TextUtils.isEmpty(type)&&type.equals("2")){//币币记录专用
                ...
                } else if ("leadercoin".equalsIgnoreCase(BuildConfig.FLAVOR) || "fireglobal".equalsIgnoreCase(BuildConfig.FLAVOR) || "aicoin".equalsIgnoreCase(BuildConfig.FLAVOR) || BuildConfig.FLAVOR.startsWith("fwdetsc") || "gliedt".equalsIgnoreCase(BuildConfig.FLAVOR)) {
                    tvProfitLabel.setText(R.string.yingli);
                    tvProfit.setText(data.profit);
                    tvProfit.setTextColor(StockChartUtil.getRateTextColor(Double.parseDouble(data.profit)));
                }
