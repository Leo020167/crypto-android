...
public class RechargeCoinAdapter extends RecyclerView.Adapter<RechargeCoinAdapter.ViewHolder>{

    private LayoutInflater mInflater;
    private List<WithdrawGetInfoBean.Infos> list = new ArrayList<>();
    private Context context;

    public RechargeCoinAdapter(Context context, List<WithdrawGetInfoBean.Infos> list){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=mInflater.inflate(R.layout.item_recharge_coin,parent,false);
