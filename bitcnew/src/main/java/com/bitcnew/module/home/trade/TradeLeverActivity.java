...
import com.bitcnew.module.home.trade.fragment.TradeLeverFragment;
...
//                            autoShowTradeDialog();//防止
    ...
    private void getRight(){
        ...
        getCoinGraphDataCall.enqueue(new MyCallBack(TradeLeverActivity.this) {
            @Override
...
//                CoinTradeEntrustLeverActivity.pageJump(TradeLeverActivity.this, accountType);
                JiaoyijiluActivity.pageJump(TradeLeverActivity.this, accountType);
                break;
            case R.id.tvCopy:
...
//                startCurrHold();
    ...
    public void startGetTradeOrderList(int isDone) {
        ...
        realCall = VHttpServiceManager.getInstance().getVService().queryList("", accountType, isDone, "", 1, "");
