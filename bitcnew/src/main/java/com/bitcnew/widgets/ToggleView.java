...
public class ToggleView extends ViewGroup {
	...
	private ToggleStateCallBack callBack;
	...
	public void setOnToggleStateChange(ToggleStateCallBack callBack) {
...
//				int centerHandleX = scrollX -  .getWidth() / 2;
...
//				setToggle(!(Math.abs(centerHandleX) > centerX), true);
	...
	public void setToggle(boolean flag, boolean animate) {
		...
		if(callBack!=null){
			callBack.onToggleStateChange(flag);
		}
//		Log.d("setToggle", "callBack=="+callBack);
		invalidate();
	}
