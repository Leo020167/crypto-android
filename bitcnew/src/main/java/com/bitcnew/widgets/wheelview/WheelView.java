...
public class WheelView extends View {
     ...
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0xFF666666;//0xFF000000

    /**
     * Top and bottom shadows colors
     */
    private static final int[] SHADOWS_COLORS = new int[]{0x26fe3f26, 0x00AAAAAA, 0x00AAAAAA};//0xFF111111, 0x00AAAAAA, 0x00AAAAAA
...
//  TODO          valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
            valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
        }

        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.ss_wheel_val);
        }
      ...
      setBackgroundResource(R.drawable.ss_wheel_bg);
    }
