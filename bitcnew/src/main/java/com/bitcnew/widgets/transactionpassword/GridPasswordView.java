...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_gpvLineWidth, DensityUtil.dip2px(getContext(), 1));
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.pay_gridpassword_view, this);
        ...
        while (index < mPasswordLength) {
            View dividerView = inflater.inflate(R.layout.pay_password_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.pay_password_textview, null);
