...
package com.bitcnew.widgets.fancycoverflow;
...
public abstract class BaseImageLoaderFancyCoverFlowAdapter<T extends TaojinluType> extends BaseImageLoaderAdapter<T> {

    // =============================================================================
    // Supertype overrides
    // =============================================================================
public BaseImageLoaderFancyCoverFlowAdapter(int defaultRes){
	super(defaultRes);
}
    @Override
    public final View getView(int i, View reusableView, ViewGroup viewGroup) {
        Log.d("getCoverFlowItem","getView=="+reusableView);
