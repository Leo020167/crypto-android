...
public class PieChartView extends View {
    ...
    public static final  int[] colors={
            ...
            Color.parseColor("#f38441"),
            Color.parseColor("#647fc6"),
            Color.parseColor("#eaf1a0"),
            Color.parseColor("#e7d7a0"),
            Color.parseColor("#64bda3"),
            Color.parseColor("#63bad5"),
            Color.parseColor("#accee1"),
            Color.parseColor("#abbf5e"),
            Color.parseColor("#f9b7c2"),
...
//        centerPaint.setStrokeWidth(centerSize);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.d("liuyz", "min:" + min + "    radius:" + radius);
    ...
    private void goDrawArc1(Canvas canvas) {
        ...
        for (int i = 0; i < data.length; i++) {
            ...
            huahu(canvas, startAngle, sweepAngle, colors[i%colors.length], i);
